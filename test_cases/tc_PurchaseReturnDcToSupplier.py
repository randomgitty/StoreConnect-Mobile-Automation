...
@allure.feature("Purchase Return DC to Supplier")
@allure.story("User views Authority Matrix via myTawasol")

def test_PurchaseReturnDcToSupplier(driver, test_data): 
    ...
    # -- Navigation 
    authority_matrix_page.navigate_to_purchase_return_dc_to_supplier()
