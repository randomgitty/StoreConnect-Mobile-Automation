...
@allure.feature("Purchase Order Branch to Supplier")
@allure.story("User views Authority Matrix via myTawasol")

def test_PurchaseOrderBranchToSupplier(driver, test_data): 
    ...
    # -- Navigation 
    authority_matrix_page.navigate_to_purchase_order_branch_to_supplier()
