...
@allure.epic("Items")
@allure.feature("Items With New Price")
@allure.story("User views items with new price via myTawasol")
def test_items_with_new_price_module(driver, test_data):
    ...
    has_data = items_page.complete_item_with_new_price_flow()
    if has_data:
        logger.info("✅ Navigating to Product Details and Stocks...")
        ...
        logger.info("✅ SUCCESS: No data available for the applied filter. Test considered successful.")